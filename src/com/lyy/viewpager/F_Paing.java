...
import com.lyy.adapter.Fs2_Adapter;
...
public class F_Paing extends Fragment {
	View view;
	ListView fs1_lv;
	int u_id;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.form_sort2, (ViewGroup) getActivity()
	...
	private void initView() {
		...
		view1 = view.findViewById(R.id.anim6);
		mAdapter = new Fs2_Adapter(getActivity(), list);
		fs1_lv = (ListView) view.findViewById(R.id.fs2_lv);
