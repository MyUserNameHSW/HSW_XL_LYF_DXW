...
import com.lyy.activities.MyCollectActivity.Myclick;
...
public class C_goods extends Fragment{
	View view, view2;
	Button deletes;
	int nowItem;
	ListView listView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.collect_goods,
	...
	private void initData() {
		...
		params.addBodyParameter("flag", "21");
		...
		utils.send(HttpMethod.POST, url, params, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> arg0) {
				...
				Gson gson = new Gson();
				Type typeOfT = new TypeToken<List<Collections>>() {
				}.getType();
				List<Collections> resultList = gson.fromJson(result, typeOfT);
				arrayList.addAll(resultList);
				dataChanged();
			}
		});
		mAdapter = new Gcol_Adapter(arrayList, getActivity());
	...
	private void initView() {
		// TODO Auto-generated method stub
		listView = (ListView) view.findViewById(R.id.gcol_listview);
