...
public class F_noPay extends Fragment {
	View view;
	ListView fs1_lv;
	int u_id;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.form_sort1, (ViewGroup) getActivity()
	...
	private void initView() {
		// TODO Auto-generated method stub
		view1 = view.findViewById(R.id.anim4);
		list = new ArrayList<MyForms>();
		mAdapter = new Fs1_Adapter(getActivity(), list);
		fs1_lv = (ListView) view.findViewById(R.id.fs1_lv);
