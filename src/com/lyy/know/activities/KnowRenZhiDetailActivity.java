...
import com.lyy.know.adapter.KnowRenZhi_DetailAdapter;
import com.lyy.project.R;
import com.lyy.util.MyApplication;

public class KnowRenZhiDetailActivity extends Activity {
	ListView listView;
	List<EssayBean> list = new ArrayList<EssayBean>();
	KnowRenZhi_DetailAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_know_ren_zhi_detail);
		initViews();
		initDatas();
	}

	private void initViews() {
		listView = (ListView) findViewById(R.id.know_renzhi_detail_lv);
		adapter = new KnowRenZhi_DetailAdapter(KnowRenZhiDetailActivity.this,
				list);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.setClass(KnowRenZhiDetailActivity.this,
						...
						try {
							...
							for (int i = 0; i < array.length(); i++) {
								...
								EssayBean essayBean = new EssayBean(E_id,
										...
										simage);
								Log.e("adadad", essayBean.toString());
								list.add(essayBean);
							}
	...
	public void ComeBack(View view) {
		KnowRenZhiDetailActivity.this.finish();
	}
}
